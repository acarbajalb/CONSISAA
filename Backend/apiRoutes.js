        ...
        db.query(nombreJefeQuery, [Id_Puesto], async (err, jefeData) => {
          ...
          db.query(
            ...
            async (err, result) => {
              ...
              registrarEnBitacora(10, "Crear usuario", "Se creó un nuevo usuario.");
...
router.get("/traerUsuarios", (req, res) => {
  ...
  db.query(query, (err, data) => {
      ...
      registrarEnBitacora( 9, "Entró a usuarios", "Se mostraron los registros de usuarios.");
  ...
  try {
    ...
    db.query(
      ...
      (err, data) => {
        ...
        registrarEnBitacora(11, "Editar usuario", `Se editó al usuario con ID ${userId}.`);
