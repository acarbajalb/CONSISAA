      ...
      async (err, result) => {
        ...
        db.query(
          ...
          async (err, result) => {
            ...
            registrarEnBitacora( 161, "Crear puesto", "Se creó un nuevo puesto.");
...
router.get("/traerPuestos", (req, res) => {
  ...
  db.query(query, (err, data) => {
      ...
      registrarEnBitacora(160, "Entró a puestos", "Se mostraron los registros de puestos.");
...
router.put("/editarPuesto/:Id_Puesto", async (req, res) => {
  try {
    ...
    registrarEnBitacora(162, "Editar puesto", `Se editó al puesto con ID ${Id_Puesto}.`);
