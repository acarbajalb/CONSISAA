   ...
   const existingTipoTelefono = await new Promise((resolve, reject) => {
    ...
    db.query(
      ...
      (err, data) => {
        ...
        registrarEnBitacora(158, "Crear tipo de teléfono", "Se creó un nuevo tipo telefono.");
...
router.get("/traerTipoTelefono", (req, res) => {
  ...
  db.query(query, (err, data) => {
      ...
      registrarEnBitacora(157, "Entró a tipos de teléfono", "Se mostraron los registros de tipos de teléfono.");
...
router.put("/editarTipoTelefono/:id_tipotelefono", async (req, res) => {
  try {
    ...
    db.query(query, values, (err, data) => {
      ...
      registrarEnBitacora(159, "Editar tipo de teléfono", `Se editó el tipo teléfono con ID ${IdTipoTelf}.`);
