   ...
   const existingEstadoCivil = await new Promise((resolve, reject) => {
    ...
    db.query(
      ...
      (err, data) => {
        ...
        registrarEnBitacora(155, "Crear estado civil", "Se creó un nuevo estado civil.");
...
router.get("/traerEstadoCivil", (req, res) => {
  ...
  db.query(query, (err, data) => {
      ...
      registrarEnBitacora(154, "Entró a estado civil", "Se mostraron los registros de estado civil.");
...
router.put("/editarEstadoCivil/:id_estadocivil", async (req, res) => {
  try {
    ...
    db.query(query, values, (err, data) => {
      ...
      registrarEnBitacora(156, "Editar estado civil", `Se editó el estado civil con ID ${IdEsCi}.`);
