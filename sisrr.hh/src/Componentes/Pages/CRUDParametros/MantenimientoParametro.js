...
const MantenimientoParametro = () => {
  ...
  const generarInforme = async () => {
    ...
    try {
      const response = await axios.get(
        "http://localhost:3001/traerBitacoraObjetosMantenimientoparametro"
      );
  ...
  const descargarInformePDF = () => {
    const doc = new jsPDF();
    const header = "Reporte de Parámetros del Sistema";
    const subtitle = "Listado de Mantenimiento de Parámetros";
            ...
            <section className="formulario">
              <div className="modal-container">
                <div className="modal-content">
                  ...
                  <h1 className="mr-5 ml-5 mt-5"> REPORTE DE MANTENIMIENTO DE PARAMETROS </h1>
                  <p></p>
                  <section className="tabla-parametro">
                    <table
                      className="table table-hover table-bordered"
                      id="tblInformeParametro"
                    >
                      <thead>
                        <tr> 
                          <th>Usuario</th> 
